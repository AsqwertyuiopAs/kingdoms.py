...
# Flask uygulama değişkeni 'kingdoms' olarak
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .couple-names { display: flex; justify-content: center; align-items: center; 
                       gap: 30px; margin: 40px 0; flex-wrap: wrap; }
        .name {
            font-size: 2.5em; font-weight: 700; padding: 20px 40px;
            background: rgba(30, 58, 138, 0.4); border-radius: 15px;
            border: 2px solid #3b82f6;
        }
        .heart { font-size: 3em; color: #ef4444; animation: heartbeat 1.5s infinite; }
        @keyframes heartbeat { 0%,100% { transform: scale(1); } 50% { transform: scale(1.2); } }
        .video-container {
            margin: 40px auto; max-width: 800px; border-radius: 20px;
        ...
        .proposal-box {
            background: rgba(15, 23, 42, 0.9); border-radius: 25px;
            padding: 60px 40px; margin: 60px auto; max-width: 900px;
            border: 2px solid #3b82f6; text-align: center;
            backdrop-filter: blur(10px);
        }
        .question {
            font-size: 2.8em; line-height: 1.4; color: #ffffff;
            margin-bottom: 40px;
        }
        .highlight { color: #60a5fa; font-weight: 800; }
        .buttons { display: flex; justify-content: center; gap: 25px;
                   margin-top: 50px; flex-wrap: wrap; }
        .btn {
            padding: 20px 50px; font-size: 1.3em; font-weight: 600;
        ...
        .yes-btn {
            ...
            color: white; box-shadow: 0 10px 25px rgba(59,130,246,0.4);
        }
        .yes-btn:hover {
        ...
        .settings-btn {
            background: rgba(30,41,59,0.9); color: #93c5fd;
            border: 2px solid #3b82f6;
        }
        .settings-btn:hover { background: rgba(59,130,246,0.2); }
        
        @media (max-width: 768px) {
            .main-title { font-size: 2.5em; }
            .question { font-size: 2em; }
            .name { font-size: 1.8em; padding: 15px 30px; }
            .btn { padding: 18px 40px; font-size: 1.1em; 
        ...
        @media (max-width: 480px) {
            ...
            .proposal-box { padding: 40px 20px; margin: 30px 15px; }
        }
    </style>
        ...
        <div class="proposal-box">
            ...
            <div class="buttons">
                <a href="#" class="btn yes-btn" onclick="handleYes()">
                    <i class="fas fa-heart"></i> EVET! Kabul Ediyorum
                </a>
...
<head>
    ...
    <style>
        ...
        .settings-container {
            ...
            background: rgba(15,23,42,0.95); border-radius: 25px;
            border: 2px solid #3b82f6;
        }
        .settings-title {
            text-align: center; font-size: 2.5em; color: #60a5fa;
            margin-bottom: 40px;
        }
        .setting-section {
            background: rgba(30,41,59,0.8); padding: 25px;
            border-radius: 15px; margin-bottom: 25px;
            border-left: 5px solid #3b82f6;
        }
        .setting-section h3 {
            color: #93c5fd; margin-bottom: 15px;
            display: flex; align-items: center; gap: 10px;
        }
        .setting-list { list-style: none; padding: 0; }
        .setting-list li {
            padding: 10px 0; border-bottom: 1px solid rgba(96,165,250,0.2);
            display: flex; align-items: center; gap: 10px;
        }
        .setting-list li:last-child { border-bottom: none; }
        .back-btn {
            display: block; width: 200px; margin: 40px auto 0;
            padding: 18px 40px; background: linear-gradient(45deg, #3b82f6, #1d4ed8);
        ...
        @media (max-width: 768px) {
            .settings-container { padding: 20px; margin: 20px; }
            .settings-title { font-size: 2em; }
        }
    </style>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</head>
    ...
    <div class="settings-container">
        ...
        <div class="setting-section">
            ...
            <ul class="setting-list">
                ...
                <li><i class="fas fa-link" style="color:#3b82f6;"></i> 
                    <a href="https://www.youtube.com/watch?v=g3dKcRJCP8U" target="_blank" style="color:#60a5fa;">
                        YouTube Linki
                    </a>
                </li>
            </ul>
        ...
        <div class="setting-section">
            ...
            <ul class="setting-list">
                <li><button onclick="window.location.href='/'" style="background:#3b82f6; color:white; border:none; padding:8px 15px; border-radius:5px; cursor:pointer;">
                    Ana Sayfaya Dön
                </button></li>
                <li><button onclick="if(confirm('Siteyi yenilemek istediğinize emin misiniz?')) location.reload()" style="background:#10b981; color:white; border:none; padding:8px 15px; border-radius:5px; cursor:pointer;">
                    Siteyi Yenile
                </button></li>
            </ul>
        </div>
...
# MAIN - Render için özel ayar
if __name__ == '__main__':
    # Render'da çalışıyorsa
    if os.environ.get('RENDER'):
        port = int(os.environ.get('PORT', 10000))
        print(f"🚀 Render'da başlatılıyor... Port: {port}")
        kingdoms.run(host='0.0.0.0', port=port, debug=False)
    else:
        # Lokal test
        print("📍 Lokal test başlatılıyor...")
        print("🌐 Site: http://localhost:5000")
        print("⚙️  Ayarlar: http://localhost:5000/ayar")
